Shader "SRP/Lit" {
	Properties {
		...
		[KeywordEnum(Off, On, Shadows)] _Clipping("Alpha Cliping", Float) = 0
	...
	SubShader {
		Pass {
			...
			#pragma multi_compile _ _DISTANCE_SHADOWMASK
		...
		Pass {
			...
			#include "./Library/ShadowCaster.hlsl"
			ENDHLSL
		}
		Pass {
			Tags {
